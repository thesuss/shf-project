...
Rails.application.config.assets.precompile += %w( master-checklists.scss )
Rails.application.config.assets.precompile += %w( user-checklists.scss )
Rails.application.config.assets.precompile += %w( progress-bar.scss )
Rails.application.config.assets.precompile += %w( user-checklists.js )
Rails.application.config.assets.precompile += %w( exception-handler.scss )
