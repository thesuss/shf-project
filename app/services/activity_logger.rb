...
class ActivityLoggerError < StandardError; end

class ActivityLoggerDirNotWritable < ActivityLoggerError; end

class InvalidLogSeverityLevel < ActivityLoggerError ; end
