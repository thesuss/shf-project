Feature: As an applicant
  ...
  #Happy paths are covered in upload.feature
  Scenario: Uploads too large file
    ...
    Then I should see t("membership_applications.create.error")
    And I should see t("membership_applications.uploads.file_too_large", filename: 'diploma_huge.pdf')
