    ...
    describe '.send_email' do
      ...
      context 'successful' do
        ...
        it 'delivers email to each member and logs each one' do
          ...
          expect(mock_log).to receive(:info).with("Alerts::CompanyEmailAlert email sent to user id: #{member1_c2_exp_jun6.id} email: #{member1_c2_exp_jun6.email} company id: #{c2_2_members.id} name: #{c2_2_members.name}.")
          expect(mock_log).to receive(:info).with("Alerts::CompanyEmailAlert email sent to user id: #{member2_c2_exp_jun1.id} email: #{member2_c2_exp_jun1.email} company id: #{c2_2_members.id} name: #{c2_2_members.name}.")
